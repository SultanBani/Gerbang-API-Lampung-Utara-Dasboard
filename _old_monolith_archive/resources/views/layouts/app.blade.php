...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    <head>
        ...
        <title>{{ config('app.name', 'Gerbang API') }} — Diskominfo Lampung Utara</title>
            ...
            <div>
                ...
                <nav class="p-4 space-y-6">
                    <div>
                        ...
                        <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('dashboard') ? 'bg-blue-600/10 text-blue-400 border-l-2 border-blue-500 pl-[10px]' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-100' }}">
