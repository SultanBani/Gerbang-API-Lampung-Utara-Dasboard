        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 space-y-5 shadow-sm dark:shadow-xl">
          ...
          <div>
            ...
            <select
              ...
              className="w-full bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-xl px-3.5 py-2 text-xs text-slate-800 dark:text-slate-200 focus:outline-none focus:border-blue-500 shadow-sm"
            >
          ...
          <div className="space-y-2">
            <div className="flex items-center">
              ...
              <input
                ...
                className="flex-1 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 py-2.5 px-3.5 font-mono text-xs text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-blue-500"
              />
              <button
              ...
              <div className="py-3 space-y-2 font-mono text-xs">
                {[
                  ...
                  <div key={k} className="flex items-center gap-2">
                    <input type="text" value={k} readOnly className="w-1/3 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg px-2.5 py-1.5 text-slate-800 dark:text-slate-200" />
                    <span className="text-slate-400">:</span>
                    <input type="text" value={v} readOnly className={`flex-1 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg px-2.5 py-1.5 font-bold ${cls}`} />
                  </div>
                ))}
              </div>
            )}
            ...
            {activeTab === 'body' && (
              <div className="py-3">
                <textarea
                  ...
                  className="w-full bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-xl p-3 font-mono text-xs text-blue-600 dark:text-blue-300 focus:outline-none focus:border-blue-500"
                ></textarea>
              </div>
            )}
              ...
              <div className="py-3 space-y-2 font-mono text-xs">
                {[['page','1'],['per_page','15']].map(([k, v]) => (
                  <div key={k} className="flex items-center gap-2">
                    <input type="text" value={k} readOnly className="w-1/3 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg px-2.5 py-1.5 text-slate-800 dark:text-slate-200" />
                    <span className="text-slate-400">=</span>
                    <input type="text" value={v} readOnly className="flex-1 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg px-2.5 py-1.5 text-slate-800 dark:text-slate-200" />
                  </div>
                ))}
              </div>
            )}
          ...
          <div>
            ...
            {responseResult && !loading && (
              <div className="relative">
                <pre className="bg-slate-900 dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl p-4 font-mono text-xs text-blue-300 overflow-x-auto leading-relaxed max-h-[320px]">
