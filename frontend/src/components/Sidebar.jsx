    ...
    <aside className="w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col justify-between flex-shrink-0 h-screen sticky top-0 transition-colors duration-300 shadow-sm z-40">
      <div>
        ...
        <nav className="p-4 space-y-5 overflow-y-auto max-h-[calc(100vh-140px)]">
          <div>
            <span className="px-3 text-[10px] font-extrabold text-slate-400 dark:text-slate-500 tracking-widest uppercase block mb-2">Utama</span>
      ...
      <div className="p-4 border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/80 backdrop-blur flex items-center justify-between transition-colors">
        <div className="flex items-center gap-3">
          ...
          <div className="leading-tight">
            <p className="text-xs font-extrabold text-slate-900 dark:text-slate-200">Admin Diskominfo</p>
            <span className="text-[10px] text-slate-500 dark:text-slate-400 font-medium">Super Administrator</span>
          </div>
        </div>
        <button title="Keluar" className="text-slate-400 hover:text-red-500 hover:bg-slate-200 dark:hover:bg-slate-800 p-2 rounded-lg transition-colors cursor-pointer">
